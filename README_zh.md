...
DBCheck 自 v2.8.0 引入了完全独立的插件架构。插件现在可以管理自己的生命周期和数据，实现真正的可扩展性。
...
**DBCheck 由个人利用业余时间开发和维护**，采用 Apache-2.0 协议完整开源，社区版永久免费，不收取任何费用。
...
> ❤️ 感谢每一位支持者的认可与鼓励。
>
> DBCheck 社区为开源软件，在开源协议许可范围内复制、修改、分发或用于商业。
>
