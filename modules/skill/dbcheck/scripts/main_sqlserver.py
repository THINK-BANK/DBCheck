...
"""
    ...
    def checkdb(self):
        ...
        try:
            from modules.inspection.slow_query import SQLServerSlowQueryAnalyzer
            if self.conn:
        ...
        try:
            from modules.inspection.config_baseline import check_sqlserver_config_baseline
            if self.conn:
        ...
        try:
            from modules.inspection.index_health import analyze_sqlserver_indexes
            if self.conn:
