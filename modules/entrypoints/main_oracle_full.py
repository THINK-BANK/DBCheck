...
try:
    ...
    from modules.entrypoints.main_mysql import RemoteSystemInfoCollector
    _HAS_SSH = True
except Exception:
    _HAS_SSH = False
...
def single_inspection(args):
    ...
    try:
        from modules.inspection.slow_query import OracleSlowQueryAnalyzer
    ...
    try:
        from modules.inspection.config_baseline import check_oracle_config_baseline
    ...
    try:
        from modules.inspection.index_health import analyze_oracle_indexes
